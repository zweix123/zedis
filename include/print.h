...
struct _is_printer_printable<
    T,
    std::void_t<typename _printer<T>::is_default_print>> : std::false_type {};
...
struct _enable_if_string<
    std::basic_string<T, Alloc, Traits>,
    U,
...
struct _enable_if_string<
    std::basic_string_view<T, Traits>,
    U,
    typename _enable_if_char<T>::type> {
    using type = U;
};
...
struct _printer<
    ...
    typename _enable_if_has_print<
        T,
        typename _enable_if_iterable<
            T,
            typename _enable_if_c_str<
                T,
                typename _enable_if_string<
                    T,
                    typename _enable_if_map<T>::not_type>::not_type>::
                not_type>::type>::not_type> {
...
struct _printer<
    ...
    typename _enable_if_has_print<
        T,
        typename _enable_if_tuple<
            T,
            typename _enable_if_iterable<T>::not_type>::type>::not_type> {
...
struct _printer<
    T,
    typename _enable_if_has_print<T, typename _enable_if_map<T>::type>::
        not_type> {
    static void print(T const &t) {
        std::cout << "{";
        bool once = false;
...
struct _printer<
    T,
    typename _enable_if_has_print<T, typename _enable_if_string<T>::type>::
        not_type> {
...
struct _printer<
    T,
    typename _enable_if_has_print<T, typename _enable_if_optional<T>::type>::
        not_type> {
    static void print(T const &t) {
        if (t.has_value()) {
...
struct _printer<
    T,
    typename _enable_if_has_print<T, typename _enable_if_variant<T>::type>::
        not_type> {
    static void print(T const &t) {
        std::visit(
            [](auto const &v) { _printer<_rmcvref_t<decltype(v)>>::print(v); },
            t);
    }
};
...
class print_adaptor {
  ...
  public:
    ...
    friend std::ostream &
    operator<<(std::ostream &os, print_adaptor const &&self) {
